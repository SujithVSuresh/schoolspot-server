...
subjectRouter.delete('/:subjectId', protectRoute(["admin"]), subjectController.deleteSubject.bind(subjectController));
...
subjectRouter.get('/:subjectId', protectRoute(["admin"]), subjectController.findSubjectById.bind(subjectController));
