...
examRouter.get('/:examId', protectRoute(["admin", "teacher", "student"]), examController.findExamById.bind(examController));
examRouter.get('/exams/:classId', protectRoute(["admin", "teacher", "student"]), examController.findExamsByClass.bind(examController));
