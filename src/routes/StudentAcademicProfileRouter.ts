...
studentAcademicProfileRouter.get("/class/:classId", protectRoute(["admin", "teacher"]), studentAcademicProfileController.fetchAcademicProfileByClassId.bind(studentAcademicProfileController));
