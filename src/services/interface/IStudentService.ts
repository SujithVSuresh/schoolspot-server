import { CreateStudentDTO, StudentPagenationResponseDTO, StudentResponseDTO, StudentSearchQueryDTO, StudentWithAcademicProfileResponseDTO, UpdateStudentDTO } from "../../dto/StudentDTO";
...
export interface IStudentService{
    ...
    getStudentById(userId: string): Promise<StudentWithAcademicProfileResponseDTO> 
