...
import { GetParamsType, GetTeacherResponseType } from "../../types/types";
...
export class TeacherService implements ITeacherService {
    ...
    async addTeacher(data: TeacherUserProfileType, file: Express.Multer.File, schoolId: string): Promise<string> {
        ...
        async getTeachers(data: GetParamsType, schoolId: string): Promise<GetTeacherResponseType> {
